    ...
    <section id="home" className="home">
      <div className="missionInner">
        ...
        <div className="tiktokCard center pulseAll" aria-live="polite">
          <div>
            <a href="https://www.tiktok.com/@boy.throb/video/7567046504649592094" target="_blank" rel="noreferrer">
              <img className="roundLogo" src="/roundlogo.png" alt="Boy Throb logo" />
            </a>
          </div>
          ...
          {/* If you want debug output during development, uncomment the block below.
              Be mindful to not reintroduce unused-state lint errors if you toggle it back in. */}
          {false && debugObj && (
