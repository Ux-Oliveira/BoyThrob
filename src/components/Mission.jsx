...
export default function Mission() {
  ...
  const debugObj = data?.debug ?? data; // fallback to whole data if no debug block
  ...
  return (
    <section id="home" className="home">
        ...
        <div className="tiktokCard center pulseAll" aria-live="polite">
          ...
          <div className="followerRow">
            {isLoading ? (
              ...
              // Error state: very visible red box with note
      ...
      {/* Inline styles: removed `jsx` attribute so React won't warn. 
          Consider moving these to src/styles.css for cleanliness. */}
      <style>{`
        /* Reduced top yellow space and slightly tighter mobile padding */
        .home {
          min-height: 100vh;
          display: flex;
          align-items: center;
        ...
        /* Very small phones: ensure legibility */
